...
import { validateForm2 } from '../../../applicant/component/LoanApplyForm/helper'
import Modals from "./Modal"

class MemberForm2 extends Component {
  state = {
  ...
  handleNext = () => {
    ...
    if (Object.keys(errors).length) {
      ...
      this.setState({ isValid: true, openModal: true })
    }
  ...
  render() {
    ...
    return (
      <div className="p-5">
        <h2 className="ml-5 mb-5 mt-5">Member Address Details</h2>
...
export default connect(mapStateToProps, mapDispatchToProps)(MemberForm2)